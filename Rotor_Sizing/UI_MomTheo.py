...
VertFli = Momentum_Theory.Vertical_Flight(mass=float(709.63/6),radius=1.17, P_a=100000)
...
power = []
for i in vel :
    ForwFli = Momentum_Theory.Forward_Flight(mass=float(709.63/6), Cd0=0.06, V=i, related_vertical=VertFli, radius = 1.17, P_a=160000)    
    # VertFli.calc_v_h()
