...
VertFli = Momentum_Theory.Vertical_Flight(mass=float(718.89/6),radius=0.96, P_a=42000)
...
power = []
for i in vel :
    ForwFli = Momentum_Theory.Forward_Flight(mass=float(718.89/6), Cd0=0.96, V=i, related_vertical=VertFli, radius = 2.01, P_a=42000)    
    # VertFli.calc_v_h()
