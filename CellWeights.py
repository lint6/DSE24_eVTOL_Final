...
class CellWeights:
    ...
    def FindDesignPoint(self):
        ...
        plt.scatter(self.i_d, self.v_d, color='orange', label='Voltage Point', zorder=5)
        plt.scatter(self.i_d, self.p_d, color='orange', label='Power Point', zorder=5)
        plt.scatter(self.i_d, self.q_d, color='orange', label='Heat Point', zorder=5)
