...
class BEMT():
    ...
    def __init__(self):
        ...
        self.R = 1.16 # m, the rotor radius in meters
    ...
    def vertical(self, omega=None, theta_r=None, c_r=None, r=None, dr=None, V_c=None, a_r=None):
        ...
        prop_1 = [dL_r,dDp_r,dT_r,dQ_r,dP_r,dP_ind,dFx]
        return prop_1
...
if __name__ == '__main__':
    ...
    if forward==True:
        ...
        for psi in BEMT.psi_list:
            for chord, theta, a, r in zip(BEMT.c_r_list, BEMT.theta_r_list, BEMT.a_r_list, BEMT.r_list):
                prop_2 = BEMT.forward(omega=BEMT.omega, theta_r=theta, c_r=chord, r=r, dr=BEMT.dr, a_r=a, V_f=-40, gamma=0.0, psi=psi, alpha_v=0.0)
                if BEMT.cutout<r<BEMT.r_e:
