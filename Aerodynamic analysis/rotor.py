...
class BEMT():
    ...
    def __init__(self):
        ...
        self.R = 1.18 # m, the rotor radius in meters
    ...
    def vertical(self, omega=None, theta_r=None, c_r=None, r=None, dr=None, V_c=None, a_r=None):
        ...
        prop_1 = [dL_r,dD_r,dT_r,dQ_r,dP_r,dFx,alpha,v_r]
        return prop_1
    ...
    def forward(self, r=None, omega=None, V_f=None, gamma=None, psi=None, alpha_v=None, theta_r=None, dr=None, a_r=None, c_r=None):
        ...
        # flight velocities
        V_ho = -V_f * np.cos(gamma) #negative value
        V_c = -V_f * np.sin(gamma) #negative value
        ...
        prop_2 = [dL_r,dD_r,dT_r,dQ_r,dP_r,dFx]
        return prop_2
